      ...
      {showCheckout && comanda && (
        <div className="fixed inset-0 bg-stone-900/95 z-50 p-6 flex flex-col gap-4 overflow-y-auto">
          ...
          <div className="bg-white rounded-3xl p-6 flex flex-col gap-4">
            ...
            <div className="bg-stone-900 text-white p-5 rounded-2xl flex justify-between items-center mt-2">
              <div className="flex flex-col"><span className="text-[8px] uppercase opacity-60">Troco / Falta</span><span className="text-xl font-black">{troco > 0 ? `Troco: ${formatCurrency(troco)}` : formatCurrency(faltaPagar)}</span></div>
